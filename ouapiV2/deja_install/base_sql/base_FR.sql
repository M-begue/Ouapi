...
('gen_version', '', 'Version du logiciel', NULL, '2', '', 1),
...
CREATE TABLE `{TAB_REF_CPU}` (
  `id` int(3) NOT NULL auto_increment,
  `libelle` varchar(100) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;[END]

CREATE TABLE `{TAB_REF_RAM_TYPE}` (
  `id` int(3) NOT NULL auto_increment,
  `libelle` varchar(50) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;[END]

CREATE TABLE `{TAB_REF_DISQUE_TYPE}` (
  `id` int(3) NOT NULL auto_increment,
  `libelle` varchar(50) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;[END]
...
CREATE TABLE `{TAB_HARDSOFT}` (
  ...
  `version_date_maj` DATE NOT NULL,
...
CREATE TABLE `{TAB_HARD}` (
  ...
  `cpu_id` int(3) default NULL,
  `ram_capacite` int(11) DEFAULT NULL,
  `ram_type_id` int(3) default NULL,
  `disque_capacite` int(11) DEFAULT NULL,
  `disque_type_id` int(3) default NULL,
...
CREATE TABLE `{TAB_USERS}` (
  ...
  `login_win` varchar(255) NOT NULL DEFAULT '',
