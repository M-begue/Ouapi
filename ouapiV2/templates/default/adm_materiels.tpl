...
<div class="textbox">
	...
	<!-- BEGIN cpu -->
	<label>{form.cpu.TITLE}</label><select name="cpu" onchange="if (document.images['imglink_cpu']) { document.images['imglink_cpu'].src='{form.TEMPLATE_ROOT}/arrow_useredit.gif' }">
		<!-- BEGIN list -->
			<option value="{form.cpu.list.ID}" {form.cpu.list.SELECTED}>{form.cpu.list.LIBELLE}</option>
		<!-- END list -->
	</select>
		<!-- BEGIN action -->
	...
	<!-- BEGIN ram_capacite -->
	<label>{form.ram_capacite.TITLE}</label><input type="text" name="ram_capacite" value="{form.ram_capacite.VALUE}" onkeydown="if (document.images['imglink_ram_capacite']) { document.images['imglink_ram_capacite'].src='{form.TEMPLATE_ROOT}/arrow_useredit.gif' }" {form.ram_capacite.DISABLED} />
		<!-- BEGIN valid -->
			<img src="{form.ram_capacite.valid.IMAGE}" border="0" name="imglink_ram_capacite" title="{form.ram_capacite.valid.LIBELLE}" onClick="{form.ram_capacite.valid.ONCLICK}" alt="" />
		<!-- END valid -->	
	<br/>
	<!-- END ram_capacite -->

	<!-- BEGIN ram_type -->
	<label>{form.ram_type.TITLE}</label><select name="ram_type" onchange="if (document.images['imglink_ram_type']) { document.images['imglink_ram_type'].src='{form.TEMPLATE_ROOT}/arrow_useredit.gif' }">
		<!-- BEGIN list -->
			<option value="{form.ram_type.list.ID}" {form.ram_type.list.SELECTED}>{form.ram_type.list.LIBELLE}</option>
		<!-- END list -->
	</select>
		<!-- BEGIN action -->
	...
	<!-- BEGIN disque_capacite -->
	<label>{form.disque_capacite.TITLE}</label><input type="text" name="disque_capacite" value="{form.disque_capacite.VALUE}" onkeydown="if (document.images['imglink_disque_capacite']) { document.images['imglink_disque_capacite'].src='{form.TEMPLATE_ROOT}/arrow_useredit.gif' }" {form.disque_capacite.DISABLED} />
		<!-- BEGIN valid -->
			<img src="{form.disque_capacite.valid.IMAGE}" border="0" name="imglink_disque_capacite" title="{form.disque_capacite.valid.LIBELLE}" onClick="{form.disque_capacite.valid.ONCLICK}" alt="" />
		<!-- END valid -->	
	<br/>
	<!-- END disque_capacite -->

	<!-- BEGIN disque_type -->
	<label>{form.disque_type.TITLE}</label><select name="disque_type" onchange="if (document.images['imglink_disque_type']) { document.images['imglink_disque_type'].src='{form.TEMPLATE_ROOT}/arrow_useredit.gif' }">
		<!-- BEGIN list -->
			<option value="{form.disque_type.list.ID}" {form.disque_type.list.SELECTED}>{form.disque_type.list.LIBELLE}</option>
		<!-- END list -->
	</select>
		<!-- BEGIN action -->
...
<!-- BEGIN form_post -->
	...
	<a href="javascript:goToHomeWithRubrique()">{form_post.CLOSE}</a></p><br/>
<!-- END form_post -->
