...
<!-- BEGIN backup_interface -->
	<div class="backup_return">
		<a href="index.php?page=accueil.php&rubrique=admin" class="button_return">
			← Retour
		</a>
	</div>
	...
	<div class="backup_create_section">
		...
		<form method="POST" action="">
			...
			<input type="submit" class="button_backup" value="{backup_interface.BUTTON_CREATE}" />
		</form>
	</div>
