<!-- BEGIN r_users -->
	...
	<!-- BEGIN addall -->
	<p class="toolbox"><img src="{r_users.addall.IMAGE}" style="vertical-align:middle" border="0" alt="" />&nbsp;<a href="{r_users.addall.LINK}">{r_users.addall.TEXT}</a></p>
	<!-- END addall -->
	

	<!-- BEGIN conf -->
	<p class="toolbox"><img src="{r_users.conf.IMAGE}" style="vertical-align:middle" border="0" alt="" />&nbsp;
	<a href="{r_users.conf.LINK}">{r_users.conf.TEXT}</a></p>
	<!-- END conf -->
	...
	<tr>
		...
		<tr class="liste">
			...
			<td class="row1">
			<!-- BEGIN tools -->
				<a href="{r_users.tab_user.list.tools.LINK}"><img src="{r_users.tab_user.list.tools.IMAGE}" style="vertical-align:middle" border="0" title="{r_users.tab_user.list.tools.TITLE}" alt="" /></a>
			<!-- END tools -->
			&nbsp;</td>
		</tr>
		<!-- END list -->
...
<!-- BEGIN r_pc -->
	...
	<!-- BEGIN addall -->
	<p class="toolbox" style="margin-left:40px;"><img src="{r_pc.addall.IMAGE}" style="vertical-align:middle" border="0" alt="" />&nbsp;<a href="{r_pc.addall.LINK}">{r_pc.addall.TEXT}</a></p>
	<!-- END addall -->
	

	<!-- BEGIN conf -->
	<p class="toolbox"><img src="{r_pc.conf.IMAGE}" style="vertical-align:middle" border="0" alt="" />&nbsp;
	<a href="{r_pc.conf.LINK}">{r_pc.conf.TEXT}</a></p>
	<!-- END conf -->

	<!-- BEGIN display -->
	<p class="toolbox"><img src="{r_pc.display.IMAGE}" style="vertical-align:middle" border="0" alt="" />&nbsp;<a href="{r_pc.display.LINK}">{r_pc.display.TEXT}</a></p>
	<!-- END display -->		
	...
	<tr>
		...
		<tr class="liste">
			...
			<td class="row1">
			<!-- BEGIN tools -->
				<a href="{r_pc.tab_pc.list.tools.LINK}"><img src="{r_pc.tab_pc.list.tools.IMAGE}" style="vertical-align:middle" border="0" title="{r_pc.tab_pc.list.tools.TITLE}" alt="" /></a>
			<!-- END tools -->
			&nbsp;</td>
		</tr>
		<!-- END list -->
