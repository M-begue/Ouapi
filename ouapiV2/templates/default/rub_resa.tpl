<!-- BEGIN r_resa -->
	...
	<!-- BEGIN display -->
	<p class="toolbox"><img src="{r_resa.display.IMAGE}" style="vertical-align:middle" border="0" alt="" />&nbsp;<a href="{r_resa.display.LINK}">{r_resa.display.TEXT}</a></p>
	<!-- END display -->		
	...
	<table class="table">
		<!-- BEGIN group -->
			...
			<tr id="{r_resa.tab_resa.group.list.ANCHOR}">
				...
				<font style="font-size:8px">{r_resa.tab_resa.group.list.next.DAY}</font><br/>
				<font style="font-size:9px">{r_resa.tab_resa.group.list.next.DATE}</font>
				</td>
				<!-- END next -->
				<td class="row1">
				<!-- BEGIN tools -->
	...
	<!-- BEGIN help -->
	<div class="help">{r_resa.help.GENERAL_HELP}</div>
	<!-- END help -->
