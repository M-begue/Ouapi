...
<div class="cat_title">{r_my.TITLE}</div>
	...
	<!-- BEGIN display -->
		<p class="toolbox" style="margin-left:40px;"><img src="{r_my.display.IMAGE}" style="vertical-align:middle" border="0" alt="" />&nbsp;<a href="{r_my.display.LINK}" target="_blank">{r_my.display.TEXT}</a></p>
	<!-- END display -->		
	...
	<!-- BEGIN infos -->
		<div style="float:left;">
		<span class="my_main_button" style="position:relative;{r_my.infos.STYLE}">{r_my.infos.TEXT}<br/><br/>
		<font style="font-size:12px;">{r_my.infos.USER_NAME}<br/>
		{r_my.infos.HARD_NAME}<br/>
		{r_my.infos.IP}<br/></font>
	...
	<!-- BEGIN links -->
		...
		<span class="{r_my.links.CLASS}" style="position:relative;{r_my.links.STYLE}">{r_my.links.TEXT}
...
<!-- BEGIN sum -->
	...
	<!-- BEGIN list_mat -->
		...
		<tr>
			<!-- BEGIN mat -->
				...
				<td class="row1" width="10%">{sum.list_mat.line.mat.NUM}</td>
			<!-- END mat -->
		</tr>		
		<!-- END line -->
	<!-- END list_mat -->
	<!-- BEGIN users -->
	<tr>
		<td class="titre2" colspan="4">{sum.users.L_USERS}</td>
	</tr>
	<tr>
