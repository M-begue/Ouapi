...
<!-- BEGIN cols -->
	...
	<center><input type="button" value="{BUTTON}" onclick="saveData(this.form)" class="non_form"/>&nbsp;&nbsp;<input type="button" value="Retour" onclick="javascript:closeToHome('{AGENCE_ID}', '{RUBRIQUE}', '{SSCAT}')" class="non_form"/></center>
