...
<!-- BEGIN form -->
	...
	<div class="textbox">
		...
		<!-- BEGIN compname -->
		<label>{form.compname.L_COMPNAME}</label> <input type="text" name="rs" value="{form.compname.VALUE}" onKeyUp="verifLong(this);"  id="{form.compname.ID}" {form.compname.DISABLED} /><br/>
		<!-- END compname -->
