<!-- BEGIN form -->
	...
	<div class="textbox">
	<!-- BEGIN help -->
		<div class="help"><img src="{form.help.IMG_HELP}" style="margin-top:-40px;margin-left:-27px;"title="{form.help.LANG_HELP}">{form.help.HELP_MESSAGE}</div>
	<!-- END help -->
	...
	<div class="cat_title2" style="margin-bottom:10px;">{form.CONFIG_HARD_TITLE}</div>
		...
		<label>{form.multisite.CONF_DS_MASK_NAME}</label> <input type="text" name="mask" value="{form.multisite.CONF_DS_MASK_VALUE}"><br/>
		<!-- END multisite -->
	...
	<font style="font-weight:bold;font-size:12px;">{form.CONFIG_SOFT_FILTER}</font><br/>
		<!-- BEGIN soft_filter -->
		<label>{form.soft_filter.CONF_SOFT_FILTER_LABEL}</label><input type="checkbox" name="{form.soft_filter.CONF_SOFT_FILTER_NAME}" 
