<!-- BEGIN r_soft -->
		...
		<a href="{r_soft.add.LINK}">{r_soft.add.TEXT}</a></p>
		<!-- END add -->
		
		<!-- BEGIN hardtype -->
		<p class="toolbox"><img src="{r_soft.hardtype.IMAGE}" style="vertical-align:middle" border="0" alt="" />&nbsp;
		<a href="{r_soft.hardtype.LINK}">{r_soft.hardtype.TEXT}</a></p>
		<!-- END hardtype -->
		
		<!-- BEGIN display -->
		<p class="toolbox"><img src="{r_soft.display.IMAGE}" style="vertical-align:middle" border="0" alt="" />&nbsp;<a href="{r_soft.display.LINK}">{r_soft.display.TEXT}</a></p>
		<!-- END display -->		
	...
	<!-- BEGIN tab_soft -->
		...
		<tr>
			...
			<tr class="{r_soft.tab_soft.type.list.CLASS_ROW}" id="{r_soft.tab_soft.type.list.ANCHOR}">
				...
				<td class="row1">
				<!-- BEGIN tools --> 
					<a href="{r_soft.tab_soft.type.list.tools.LINK}"><img src="{r_soft.tab_soft.type.list.tools.IMAGE}" border="0" title="{r_soft.tab_soft.type.list.tools.TITLE}" alt="" /></a> 
				<!-- END tools --> 
				</td>
			</tr>
			<!-- END list -->
