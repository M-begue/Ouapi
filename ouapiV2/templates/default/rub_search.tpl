<!-- BEGIN r_search -->	
	<!-- BEGIN header -->
	<div class="search_title1"><img src="{r_search.header.TABLE_IMAGE}" style="width:20px;vertical-align:middle" alt="" />&nbsp;{r_search.header.TABLE_NAME}</div>
		<!-- BEGIN list -->
		<div class="search_result">
			...
			<div style="float:right;width:86%">
				...
				<!-- BEGIN tools -->
					...
					<span style="margin-right:10px;"><a href="{r_search.header.list.tools.LINK}" class="search_link" target="{r_search.header.list.tools.TARGET}">{r_search.header.list.tools.TEXT}</a></span>
				<!-- END tools -->
				</div>
			</div>
