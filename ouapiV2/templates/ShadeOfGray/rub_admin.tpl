...
<!-- BEGIN r_admin -->
	...
	<div class="rightmain">
		...
		<div class="rightinmain">
			...
			<!-- END new -->	
			<!-- BEGIN no -->
				<div class="textbox_white" style="margin-top:10px;margin-bottom:10px;"><i>{r_admin.maj.no.TITLE}</i></div>
			<!-- END no -->	
		</div>
		<!-- END maj -->	
		...
		<div class="rightinmain">
			...
			<font style="font-weight:bold; color:#FFF;">{r_admin.stats.SUBTITLE}</font><br/>
			
			
			<!-- BEGIN last_update -->
				<font style="color:#FFF;">{r_admin.stats.last_update.LABEL}</font>
				<input type="hidden" name="lastupdate" value="{r_admin.stats.last_update.VALUE}" />{r_admin.stats.last_update.DATE}<br/>
			<!-- END last_update -->

			<!-- BEGIN infos -->
				<br/>
        <input type="radio" name="references" value="Oui" class="non_form" checked="checked" onclick="javascript:document.getElementById('company').style.display='block'" />&nbsp;<font style="color:#FFF;">{r_admin.stats.infos.REFERENCEYES}&nbsp;</font><br/>
				<input type="radio" name="references" value="Non" class="non_form"  onclick="javascript:document.getElementById('company').style.display='none'"/>&nbsp;<font style="color:#FFF;">{r_admin.stats.infos.REFERENCENO}&nbsp;</font><br/><br/>
			
				<div id="company" class="textbox_white">
			...
			<div class="textbox_white" style="margin-left:10px;margin-top:5px;">
		...
		<font style="color:#FFF;">{r_admin.news.TEXT_NEWS}</font>
		</div>
		<!-- END news -->	
		...
		<div class="rightinmain">
			...
			<tr>
				...
				<!-- BEGIN list -->
					<tr>
						...
						<!-- BEGIN desc -->
						<br/>
            <i>{r_admin.param_gen.subcat.list.desc.LIBELLE}</i>
						<!-- END desc -->
						</td>
			...
			<!-- END subcat -->
			<tr>
				<td class="row1"><b>{r_admin.param_gen.L_OCSACTIVE}</b><br/><i>{r_admin.param_gen.DESC_OCSACTIVE}</i></td>
				<td class="row1" style="padding:5px;">
				<!-- BEGIN ocs -->
			...
			<tr>
				<td class="row1"><b>{r_admin.param_gen.L_LDAPACTIVE}</b><br/><i>{r_admin.param_gen.DESC_LDAPACTIVE}</i></td>
				<td class="row1" style="padding:5px;">
				<!-- BEGIN ldap -->
			...
			<tr>
				<td class="row1"><b>{r_admin.param_gen.L_MULTIACTIVE}</b><br/><i>{r_admin.param_gen.DESC_MULTIACTIVE}</i></td>
				<td class="row1" style="padding:5px;">
				<!-- BEGIN multi -->
		...
		<div class="rightinmain">
			...
			<input type="submit" name="submit" value="{r_admin.rights.GRPADD_BUTTON}" class="non_form" style="margin-left:10px;" />
			</div>
			</form>
		</div>
		<div class="rightinmain">
			...
			<!-- BEGIN grp_list -->
				<option value="{r_admin.rights.grp_list.ID}" {r_admin.rights.grp_list.SELECTED}>{r_admin.rights.grp_list.NAME}</option>
			<!-- END grp_list -->
			</select>
			</div>
			</form>
			...
			<!-- BEGIN grp -->
				<div style="padding:10px;margin-bottom:20px;border-top:1px solid #DDDDDD;" class="textbox_white"><b>{r_admin.rights.grp.TEXT_EDIT}</b>
        ...
        <table class="table">
			...
			<!-- BEGIN del_grp -->
				<div style="padding:10px;margin-bottom:20px;border-top:1px solid #DDDDDD;" class="textbox_white"><b>{r_admin.rights.del_grp.TEXT_DEL}</b><br/>
				...
				<!-- BEGIN list -->
					<option value="{r_admin.rights.del_grp.list.ID}">{r_admin.rights.del_grp.list.NAME}</option>
				<!-- END list -->
				</select>
			...
			<tr>
				...
				<!-- BEGIN list -->
					<tr>
						...
						<!-- BEGIN desc -->
						<br/><i>{r_admin.param_ldap.subcat.list.desc.LIBELLE}</i>
						<!-- END desc -->
						</td>
						<td class="row1" style="padding:5px;">				
						<!-- BEGIN text -->
		...
		<div class="rightinmain">
			...
			<!-- BEGIN list -->
				<tr>
					...
					<!-- BEGIN desc -->
					<br/><i>{r_admin.param_ocs.list.desc.LIBELLE}</i>
					<!-- END desc -->
					</td>
					<td class="row1" style="padding:5px;">				
					<!-- BEGIN text -->
			...
			<table class="table">
				...
				<tr>
					...
					<i>{r_admin.param_ocs.config.list.DESC}</i></td>
		...
		<div class="cat_title2">{r_admin.param_plugin.TITLE_NEW}</div>
			...
			<!-- BEGIN list_new -->
				<tr>
					...
					<!-- BEGIN desc -->
					<br/>
          <i>{r_admin.param_plugin.list_new.desc.LIBELLE}</i>
					<!-- END desc -->
					</td>
					...
					<td class="row1" style="padding:5px;">
					<!-- BEGIN tools -->
					<a href="{r_admin.param_plugin.list_new.tools.LINK}" target="_blank"><img src="{r_admin.param_plugin.list_new.tools.IMAGE}" border="0" title="{r_admin.param_plugin.list_new.tools.TITLE}" alt= "" /></a> 
					<!-- END tools -->
					</td>
				</tr>
			<!-- END list_new -->
			...
			<!-- BEGIN list_update -->
				<tr>
					...
					<!-- BEGIN desc -->
					<br/>
          <i>{r_admin.param_plugin.list_update.desc.LIBELLE}</i>
					<!-- END desc -->
					</td>
					...
					<td class="row1" style="padding:5px;">
					<!-- BEGIN tools -->
					<a href="{r_admin.param_plugin.list_update.tools.LINK}" target="_blank"><img src="{r_admin.param_plugin.list_update.tools.IMAGE}" border="0" title="{r_admin.param_plugin.list_update.tools.TITLE}" alt=""/></a> 
					<!-- END tools -->
					</td>
				</tr>
			<!-- END list_update -->
			...
			<!-- BEGIN list_inst -->
				<tr>
					...
					<!-- BEGIN desc -->
					<br/>
          <i>{r_admin.param_plugin.list_inst.desc.LIBELLE}</i>
					<!-- END desc -->
					</td>
					...
					<td class="row1" style="padding:5px;">
					<!-- BEGIN tools -->
					<a href="{r_admin.param_plugin.list_inst.tools.LINK}" target="_blank"><img src="{r_admin.param_plugin.list_inst.tools.IMAGE}" border="0" title="{r_admin.param_plugin.list_inst.tools.TITLE}" alt=""/></a> 
					<!-- END tools -->
					</td>
				</tr>
			<!-- END list_inst -->
