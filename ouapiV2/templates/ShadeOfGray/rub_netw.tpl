...
<!-- BEGIN r_netw -->
	<form method="post" name="formexport" action="index.php?page=export.php&amp;export=netw&amp;type=excel">	
		...
		<p class="toolbox">
			...
			<a href="{r_netw.add.LINK}">{r_netw.add.TEXT}</a>
		</p>
		<!-- END add -->
		...
		<p class="toolbox">
			...
			<a href="{r_netw.display.LINK}">{r_netw.display.TEXT}</a>
		</p>
		<!-- END display -->		
		...
		<p class="toolbox">
			...
			<a href="{r_netw.hardtype.LINK}">{r_netw.hardtype.TEXT}</a>
		</p>
		<!-- END hardtype -->
	</form>
	...
	<div style="width:100%;padding:0;margin-top:35px;">
		...
		<tr>
			<td style="background-color:#BDBDBD;padding:2px;padding-right:10px;color:white;vertical-align:top;">
				...
				<!-- BEGIN ip -->
				<a href="http://{r_netw.equipmt.NAME}">{r_netw.equipmt.NAME}</a>
				<!-- END ip -->
				</font>
			</td>
	...
	<!-- BEGIN group -->
		...
		<tr class="{r_netw.tab_netw.group.list.CLASS_ROW}" id="{r_netw.tab_netw.group.list.ANCHOR}">
			...
			<td class="row1">
			<!-- BEGIN tools --> 
				<a href="{r_netw.tab_netw.group.list.tools.LINK}">
				<img src="{r_netw.tab_netw.group.list.tools.IMAGE}" border="0" title="{r_netw.tab_netw.group.list.tools.TITLE}" alt="" /></a> 
			<!-- END tools --> 
			</td>
		</tr>
		<!-- END list -->
