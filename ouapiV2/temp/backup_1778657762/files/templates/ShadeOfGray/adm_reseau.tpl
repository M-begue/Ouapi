...
<!-- BEGIN form -->
    ...
    <select name="hardware_id" {form.hard.DISABLED}>
			<!-- BEGIN list -->
		...
		<!-- BEGIN numero_select -->
		<label>{form.numero_select.TITLE}</label>
    <select name="numero" {form.numero_select.DISABLED}>
			<!-- BEGIN list -->
		...
		<!-- BEGIN empl -->
		<label>{form.empl.TITLE}</label>
    <select name="emplacement_id" {form.empl.DISABLED}>
			<!-- BEGIN list -->
		...
		<!-- BEGIN netw -->
		<label>{form.netw.TITLE}</label>
    <select name="switch_id" {form.netw.DISABLED}>
			<!-- BEGIN list -->
...
<!-- BEGIN help -->
<div class="help"><img src="{help.IMG}" style="margin-top:-40px;margin-left:-27px;" title="{help.IMG_TITLE}" alt="">{help.GENERAL_HELP}</div>	
<!-- END help -->
