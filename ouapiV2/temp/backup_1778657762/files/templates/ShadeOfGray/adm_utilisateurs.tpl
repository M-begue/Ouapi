...
<!-- BEGIN form -->
	...
	<div class="textbox_white">
		...
		<!-- BEGIN ldap_head -->
			<p class="head_baseouapi">{form.ldap_head.L_BASEINFO}</p>
      <p class="head_baseexterne">{form.ldap_head.L_LDAPINFO}</p><br/>
		<!-- END ldap_head -->
		...
		<input type="text" name="nom" value="{form.name.VALUE}" id="{form.name.ID}" onkeyup="{form.name.KEYUP}" onkeydown="if (document.images['imglink_nom']) { document.images['imglink_nom'].src='{form.TEMPLATE_ROOT}/arrow_useredit.gif' }" {form.name.DISABLED} >
			<!-- BEGIN action -->
				<a href="{form.name.action.LINK}"><img src="{form.name.action.IMAGE}" border="0" title="{form.name.action.LIBELLE}" name="imglink_nom" alt=""></a>
			<!-- END action -->	
			<!-- BEGIN valid -->
				<img src="{form.name.valid.IMAGE}" border="0" name="imglink_nom" title="{form.name.valid.LIBELLE}" onClick="{form.name.valid.ONCLICK}" alt="">
			<!-- END valid -->	
			<!-- BEGIN ldap -->
    ...
    <select name="ut_agence">
		...
		<!-- BEGIN lang -->
		<label>{form.lang.TITLE}</label>
    <select name="ut_langue">
			<!-- BEGIN list -->
		...
		<!-- BEGIN group -->
		<label>{form.group.TITLE}</label>
    <select name="ut_groupe">
			<!-- BEGIN list -->
...
<!-- BEGIN addall_ldap -->
	...
	<div class="textbox">
		...
		<!-- BEGIN duplicate -->
		<label>{addall_ldap.duplicate.TITLE}</label>
    <select name="duplicate">
		...
		<!-- BEGIN group -->
		<label>{addall_ldap.group.TITLE}</label>
    <select name="groupe_id">
		...
		<!-- BEGIN login -->
		<label>{addall_ldap.login.TITLE}</label>
    <select name="default_login">
			<!-- BEGIN list -->
		...
		<!-- BEGIN mdp -->
		<label>{addall_ldap.mdp.TITLE}</label>
    <select name="default_mdp">
			<!-- BEGIN list -->
