...
class Template {
	...
	public array $compiled_code = array();

	// This will hold the uncompiled code for that handle.
	public array $uncompiled_code = array();
	 ...
	 */
	public function assign_vars(array $vararray): bool
	{
	 ...
	 * any existing variable assignment with the same name.
	 */
	public function assign_var(string $varname, string $varval): bool
	{
	 ...
	 */
	public function loadfile(string $handle): bool
	{
	 ...
	 */
	public function compile(string $code, bool $do_not_echo = false, string $retvar = ''): string
	{
	 ...
	 */
	public function generate_block_varref(string $namespace, string $varname): string
	{
	 ...
	 */
	public function generate_block_data_ref(string $blockname, bool $include_last_iterator): string
	{
