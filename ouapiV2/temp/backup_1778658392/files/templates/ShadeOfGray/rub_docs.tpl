...
<!-- BEGIN r_docs -->
	<form method="post" name="formexport" action="index.php?page=export.php&amp;export=docs&amp;type=excel" target="_blank">	
		...
		<p class="toolbox">
			...
			<a href="{r_docs.add.LINK}" target="_blank">{r_docs.add.TEXT}</a>
		</p>
		<!-- END add -->
	
		<!-- BEGIN display -->
		<p class="toolbox">
			<img src="{r_docs.display.IMAGE}" style="vertical-align:middle" border="0" alt="" />&nbsp;
			<a href="{r_docs.display.LINK}" target="_blank">{r_docs.display.TEXT}</a>
		</p>
		<!-- END display -->		
		...
		<!-- BEGIN export -->
			<p class="toolbox">
				...
				<a href="#" onclick="{r_docs.export.LINK}">{r_docs.export.TEXT}</a>
			</p>
		<!-- END export -->
	</form>
	...
	<!-- BEGIN help -->
	<div class="help">
		<img src="{r_docs.help.IMG_HELP}" style="margin-top:-40px; margin-left:-27px;" title="{r_docs.help.IMG_TITLE}" alt="" />{r_docs.help.GENERAL_HELP}
	</div>
	<!-- END help -->
