...
<div class="textbox_white">
  ...
  <input type="text" name="num_serie" value="{form.serial.VALUE}" onkeydown="if (document.images['imglink_numserie']) { document.images['imglink_numserie'].src='{form.TEMPLATE_ROOT}/arrow_useredit.gif' }" {form.serial.DISABLED} />
		<!-- BEGIN action -->
  ...
  <select name="marque" onchange="{form.marque.ONCHANGE}">
		<!-- BEGIN list -->
  ...
  <select name="agence_id">
	...
	<!-- BEGIN emplacement -->
	<label>{form.emplacement.TITLE}</label>
  <select name="emplacement">
	...
	<!-- BEGIN user -->
	<label>{form.user.TITLE}</label>
  <select name="user" onchange="if (document.images['imglink_user']) { document.images['imglink_user'].src='{form.TEMPLATE_ROOT}/arrow_useredit.gif' }">
		<!-- BEGIN list -->
	...
	<!-- BEGIN os -->
	<label>{form.os.TITLE}</label>
  <select name="os" onchange="if (document.images['imglink_os']) { document.images['imglink_os'].src='{form.TEMPLATE_ROOT}/arrow_useredit.gif' }">
		<!-- BEGIN list -->
	...
	<!-- BEGIN ip -->
	<label>{form.ip.TITLE}</label>
  <input type="text" name="ip" value="{form.ip.VALUE}" onkeydown="if (document.images['imglink_ip']) { document.images['imglink_ip'].src='{form.TEMPLATE_ROOT}/arrow_useredit.gif' }" {form.ip.DISABLED} />
		<!-- BEGIN action -->
  ...
  <textarea name="commentaire" id="comment_textarea">{form.comment.VALUE}</textarea>
		<!-- BEGIN action -->
  ...
  <textarea name="suivi" rows="10" cols="50" style="vertical-align:top">{form.rebus.VALUE}</textarea><br/>
	...
	<!-- BEGIN key -->	
		...
		<img src="{form.TEMPLATE_ROOT}/arrow_ok.gif" style="vertical-align:middle;margin-left:10px;" alt="" />&nbsp;{form.key.L_OK}<br/>
		<img src="{form.TEMPLATE_ROOT}/arrow.gif" style="vertical-align:middle;margin-left:10px;" alt="" />&nbsp;{form.key.L_TRANS}<br/>
		<img src="{form.TEMPLATE_ROOT}/arrow_add.gif" style="vertical-align:middle;margin-left:10px;" alt="" />&nbsp;{form.key.L_ADD}<br/>
		<img src="{form.TEMPLATE_ROOT}/arrow_useredit.gif" style="vertical-align:middle;margin-left:10px;" alt="" />&nbsp;{form.key.L_USER}<br/>
		<img src="{form.TEMPLATE_ROOT}/arrow_forbid.gif" style="vertical-align:middle;margin-left:10px;" alt="" />&nbsp;{form.key.L_FORBID}<br/>
		</div>
	<!-- END key -->	
