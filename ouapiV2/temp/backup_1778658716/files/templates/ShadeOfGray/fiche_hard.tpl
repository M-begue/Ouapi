...
<!-- BEGIN hard_periph -->
	...
	<!-- BEGIN list -->
		<tr>
			...
			<td class="{hard_periph.list.CLASS}" width="57%">{hard_periph.list.MARQUE}&nbsp;-&nbsp;{hard_periph.list.MODELE}&nbsp;-&nbsp;{hard_periph.list.NAME}</td>
			<td class="{hard_periph.list.CLASS}" width="20%">{hard_periph.list.SERIAL}</td>
			<td class="{hard_periph.list.CLASS}" align="right" width="7%">
			<!-- BEGIN tools -->	
...
<!-- BEGIN hard_ocsdetails -->
	...
	<!-- BEGIN drives -->	
	<div class="fiche_hard_ocsblocks" style="margin-left:4px;">
	<p class="cat_title2" style="margin-top:0;">{hard_ocsdetails.drives.TITLE}</p>
		<!-- BEGIN list -->	
		<div>
		...
		<p class="fiche_hard_drive" style="background:url('{hard_ocsdetails.drives.list.BGIMG}');background-size:{hard_ocsdetails.drives.list.PRCT}%;background-repeat:no-repeat; ">&nbsp;{hard_ocsdetails.drives.list.TEXT}
		</p>
		</div>
		</div>
		<div style="clear:both">&nbsp;</div>
	...
	<div class="fiche_hard_ocsblocks" style="margin-left:4px;">
	<p class="cat_title2" style="margin-top:0;">{hard_ocsdetails.PROCMEM_TITLE}</p>	
	...
	<div class="fiche_hard_ocsblocks" style="margin-left:4px;">
	<p class="cat_title2" style="margin-top:0;">{hard_ocsdetails.OS_TITLE}</p>
		...
		<div style="float:left;width:77%;">{hard_ocsdetails.OSNAME}<br/>
		{hard_ocsdetails.SP}<br/>
		{hard_ocsdetails.L_OSVERSION}&nbsp;{hard_ocsdetails.OSVERSION}
		</div>
		...
		<div style="float:left;width:77%;">{hard_ocsdetails.WORKGROUP}</div>
		...
		<div style="float:left;width:77%;">{hard_ocsdetails.WINOWNER}</div>

	</div>
	
	<div class="fiche_hard_ocsblocks" style="margin-left:5px;">
	<p class="cat_title2" style="margin-top:0;">{hard_ocsdetails.OTHER_TITLE}</p>
...
<!-- BEGIN hard_softocs -->
	...
	<div id="hard_softocs" style="display:none;">
		<div class="fiche_hard_ocsblocks" style="margin-left:4px;width:96%;height:auto;">
		<p class="cat_title2" style="margin-top:0;">{hard_softocs.auto.L_DETAILS}</p>
		<table class="table">
			<!-- BEGIN line -->
			<tr>
				<!-- BEGIN col -->
	...
	<div id="hard_softocs" style="display:none;">
		...
		<table class="table">
				...
				<!-- BEGIN no_soft -->
				<tr>
					<td colspan="3" class="row1"><i>{hard_softocs.manual.no_soft.L_NOSOFT}</i></td>
				</tr>
				<!-- END no_soft -->
				<!-- BEGIN add -->	
				<tr>
