...
<!-- BEGIN r_users -->
	<form method="post" name="formexport" action="index.php?page=export.php&amp;export=users&amp;type=excel" target="_blank">
		...
		<!-- BEGIN export -->
		<input type="hidden" name="nom" value="{r_users.export.NOM}" />
		<input type="hidden" name="export_data" value="{r_users.export.DATA}" />
		<p class="toolbox">
			<img src="{r_users.export.IMAGE}" style="vertical-align:middle" border="0" alt="" />&nbsp;
			<a href="#" onclick="{r_users.export.LINK}">{r_users.export.TEXT}</a>
		</p>
		<!-- END export -->
	</form>
	...
	<!-- BEGIN filters -->
		<form name="formfilter" action="index.php" method="get">	
			...
			<p class="toolbox">{r_users.filters.TEXT}&nbsp;
				<input type="text" value="" name="filter_text" class="search_field_ldap" style="margin-top:-1px;" />
				<input type="image" name="filter_submit" src="{r_users.filters.IMG}" title="{r_users.filters.LANG_FILTER}" class="search_ldap" style="margin-top:-1px;" />
			</p>
		</form>
	<!-- END filters -->
...
<!-- BEGIN r_pc -->
	<form method="post" name="formexport" action="index.php?page=export.php&amp;export=users&amp;type=excel" target="_blank">
		...
		<!-- BEGIN export -->
		<input type="hidden" name="nom" value="{r_pc.export.NOM}" />
		<input type="hidden" name="export_data" value="{r_pc.export.DATA}" />
		<p class="toolbox">
			<img src="{r_pc.export.IMAGE}" style="vertical-align:middle" border="0" alt="" />&nbsp;
			<a href="#" onclick="{r_pc.export.LINK}">{r_pc.export.TEXT}</a>
		</p>
		<!-- END export -->
	</form>
	...
	<!-- BEGIN filters -->
		<form name="formfilter" action="index.php" method="get">	
			...
			<p class="toolbox">{r_pc.filters.TEXT}&nbsp;
				<input type="text" value="" name="filter_text" class="search_field_ldap" style="margin-top:-1px;" />
				<input type="image" name="filter_submit" src="{r_pc.filters.IMG}" title="{r_pc.filters.LANG_FILTER}" class="search_ldap" style="margin-top:-1px;" />
			</p>
		</form>
	<!-- END filters -->
