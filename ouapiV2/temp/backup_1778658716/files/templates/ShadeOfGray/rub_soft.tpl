...
<!-- BEGIN r_soft -->
	...
	<!-- BEGIN tab_soft -->
		...
		<form method="post" name="formexport" action="index.php?page=export.php&amp;export=soft&amp;type=excel" target="_blank">
			...
			<p class="toolbox">
				<img src="{r_soft.tab_soft.export.IMAGE}" style="vertical-align:middle" border="0" alt="" /> 
				<a href="#" onclick="{r_soft.tab_soft.export.LINK}">{r_soft.tab_soft.export.TEXT}</a>
			</p>
		</form>
		<!-- END export -->
	...
	<!-- BEGIN help -->
	<div class="help">
		<img src="{r_soft.help.IMG_HELP}" style="margin-top:-40px; margin-left:-27px;" title="{r_soft.help.IMG_TITLE}" alt="" />{r_soft.help.GENERAL_HELP}
	</div>
	<!-- END help -->
