...
<div class="textbox">
	...
	<!-- BEGIN tab_hard -->
		<!-- BEGIN header -->
		<tr>
			<td class="titre2" colspan="4">{tab_hard.header.TYPE_NAME}</td>
		</tr>
		<tr>
			<td class="titre3" width="20%">{tab_hard.header.L_HARDNAME}</td>
			<td class="titre3" width="20%">{tab_hard.header.L_USER}</td>
			<td class="titre3" width="30%">{tab_hard.header.L_VERSION}</td>
			<!-- BEGIN col_serial -->
				<td class="titre3" width="30%">{tab_hard.header.col_serial.L_LICENCE}</td>
			<!-- END col_serial -->
			...
			<tr>
				...
				<!-- BEGIN col_serial -->
					...
					<div style="text-align:right;"><button onclick="javascript:document.getElementById('{tab_hard.header.list.col_serial.ADD_SERIAL_ID}').style.display='block';this.style.display='none'">{tab_hard.header.list.col_serial.ADD_SERIAL}&nbsp;<img src="{tab_hard.header.list.col_serial.ADD_SERIAL_IMG}" alt='' /></button></div>
