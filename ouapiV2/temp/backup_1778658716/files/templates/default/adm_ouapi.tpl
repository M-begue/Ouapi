...
<!-- BEGIN maj_stage1 -->
	...
	<div class="textbox">
		...
		<form name="form" action="index.php?page=adm_ouapi.php&amp;stage=2" method="post" enctype="multipart/form-data">
			<input type="radio" name="uploadtype" value="uploadfile" style="vertical-align:middle;" class="non_form" />&nbsp;{maj_stage1.UPLOAD}&nbsp;<input type="file" name="doc" value="" class="non_form" /><br/><br/>
			<input type="radio" name="uploadtype" value="downloadfile" style="vertical-align:middle;" class="non_form" checked="checked" />&nbsp;{maj_stage1.DOWNLOAD}<br/><br/>
...
<!-- BEGIN maj_stage2 -->
	...
	<div class="textbox">
		...
		<tr>
			...
			<td style="margin:0;padding:0;border:0" colspan="2"><div class="{maj_stage2.tests.CLASS}" style="padding:5px;font-size:8pt;">
			<img src="templates/{maj_stage2.DEFAULT_TEMPLATE}/images/{maj_stage2.tests.IMAGE}.png" alt="" style="vertical-align:middle;margin-right:10px;" />{maj_stage2.tests.RESULT}{maj_stage2.tests.MESSAGE}</div></td>
		</tr>
		<!-- END tests -->
		</table><br/><br/>
		...
		<form name="form" action="index.php?page=adm_ouapi.php&amp;stage=3" method="post" enctype="multipart/form-data">
			...
			<center><input type="submit" value="{maj_stage2.tests_ok.L_CONTINUE}" class="non_form" /></center>
		</form>		
		<!-- END tests_ok -->
