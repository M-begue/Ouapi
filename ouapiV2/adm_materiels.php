...
if (isset($_POST['soumettre']))
{
	...
	else
	{
		...
		if (isset($_GET['action']) && $_GET['action'] == 'Ajouter')
		{
			...
			$requete = "INSERT INTO ".TAB_HARD." (nom,num_serie,type_id,marque_id,modele_id,os_id,user_id,agence_id,emplacement_id,ip,reservable,commentaire,suivi_rebus,creation_date".$pfields_names.")
				VALUES ('".$nom."','".$num_serie."','".$type."','".$marque."','".$modele."','".$os."','".$user."','".$agence_id."','".$emplacement."','".$ip."','".$reservable."','".$commentaire."','','".$date."'".$pfields_values.")";
		...
		elseif (isset($_GET['action']) && $_GET['action'] == 'editer')
		{
			...
			modele_id='$modele',os_id='$os',user_id='$user',agence_id='$agence_id',emplacement_id='$emplacement',ip='$ip',reservable='$reservable',commentaire='$commentaire',creation_date='$date'".$pfields_update." WHERE id='$h_id'";
			$tab = $req1->db_use_query($requete);
